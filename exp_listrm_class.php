...
// $Id: exp_listrm_class.php 4350 2021-03-02 19:14:52Z duncan $
// List RM class - list classes for tractors/trailers
...
$filters_html = '<div class="btn-group"><a class="btn btn-sm btn-success" href="exp_listrm_class.php"><span class="glyphicon glyphicon-refresh"></span></a>';
$valid_sources = $rm_class_table->get_types();
...
$filters_html .= ' <div class="btn-group"><a class="btn btn-sm btn-default" href="exp_listrm_form.php"><span class="glyphicon glyphicon-th-list"></span> Forms</a>';

$sts_result_rm_class_edit['filters_html'] = $filters_html;

$rslt = new sts_result( $rm_class_table, $match, $sts_debug );
echo $rslt->render( $sts_result_rm_class_layout, $sts_result_rm_class_edit );
