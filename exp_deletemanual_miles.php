...
if( isset($_GET['CODE']) ) {
	$result = $manual_miles_table->delete( $_GET['CODE'], 'permdel' );
	if( $sts_debug ) echo "<p>result = ".($result ? 'true' : 'false '.$manual_miles_table->error())."</p>";
}

if( ! $sts_debug )
	reload_page ( "exp_listmanual_miles.php" );	// Back to list manual_miless page