...
$oauth_client_id = 'ABnNYoMr2uEwAIwNPboKtbT3KlgXhmFt4ymWzSFOTsPX0aiiJK';
$oauth_client_secret = 'LxnGR8R3JG4SFJHF0rfJViotQIUOkWlhbCBcS3F8';
...
$quickbooks_oauth_url = 'http://strongtco.dyndns.org:2378/exspeedite/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = 'http://strongtco.dyndns.org:2378/exspeedite/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/success.php';

// This is the menu URL script
$quickbooks_menu_url = 'http://strongtco.dyndns.org:2378/exspeedite/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/menu.php';

// This is a database connection string that will be used to store the OAuth credentials
// $dsn = 'pgsql://username:password@hostname/database';
// $dsn = 'mysql://username:password@hostname/database';
$dsn = 'mysqli://exp_admin:8eccfa1512bdeda25961d120c5e4d29a@127.0.0.1/pipco1';
