...
$manual_miles_form = new sts_form( $sts_form_addmanual_miles_form, $sts_form_add_manual_miles_fields, $manual_miles_table, $sts_debug);

if( isset($_POST) && count($_POST) > 0 ) {		// Process completed form
	$result = $manual_miles_form->process_add_form();

	if( $sts_debug ) die; // So we can see the results
	if( $result ) 
		if( isset($_POST["saveadd"]) )
			reload_page ( "exp_addmanual_miles.php" );
		else
