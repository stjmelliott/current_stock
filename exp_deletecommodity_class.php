...
if( isset($_GET['CODE']) ) {
	$result = $commodity_class_table->delete( $_GET['CODE'], 'permdel' );
	if( $sts_debug ) echo "<p>result = ".($result ? 'true' : 'false '.$commodity_class_table->error())."</p>";
}

if( ! $sts_debug )
	reload_page ( "exp_listcommodity_class.php" );	// Back to list commodity_classs page