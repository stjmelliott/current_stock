...
$sts_result_email_attach_edit['title'] .= '<br>Default: '.htmlspecialchars($email_attach_table->default_from());

$rslt = new sts_result( $email_attach_table, $match, $sts_debug );
echo $rslt->render( $sts_result_email_attach_layout, $sts_result_email_attach_edit );
