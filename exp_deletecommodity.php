...
if( isset($_GET['CODE']) ) {
	$result = $commodity_table->delete( $_GET['CODE'], 'permdel' );
	if( $sts_debug ) echo "<p>result = ".($result ? 'true' : 'false '.$commodity_table->error())."</p>";
}

if( ! $sts_debug )
	reload_page ( "exp_listcommodity.php" );	// Back to list commoditys page