...
// $Id: exp_import_tractors_kt.php 4350 2021-03-02 19:14:52Z duncan $
// Import Tractors from KeepTruckin
...
if( $kt->is_enabled() ) {
	...
	echo '<h1 class="text-center">Import Tractors From KeepTruckin</h1>
	<br><br><br>
