<?php
/**
 * File for class PCMWSStructImportAFSetResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructImportAFSetResponse originally named ImportAFSetResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructImportAFSetResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructImportAFSetResponseBody
     */
    public $Body;
    /**
     * Constructor method for ImportAFSetResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructImportAFSetResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructImportAFSetResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructImportAFSetResponseBody $_body the Body
