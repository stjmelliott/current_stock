<?php
/**
 * File for class PCMWSStructImportAFSetRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructImportAFSetRequest originally named ImportAFSetRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructImportAFSetRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructImportAFSetRequestBody
     */
    public $Body;
    /**
     * Constructor method for ImportAFSetRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructImportAFSetRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructImportAFSetRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructImportAFSetRequestBody $_body the Body
