<?php
/**
 * File for class PCMWSStructCustomPlaceResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructCustomPlaceResponse originally named CustomPlaceResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructCustomPlaceResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructCustomPlaceResponseBody
     */
    public $Body;
    /**
     * Constructor method for CustomPlaceResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructCustomPlaceResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructCustomPlaceResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructCustomPlaceResponseBody $_body the Body
