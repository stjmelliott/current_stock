<?php
/**
 * File for class PCMWSStructCustomPlaceRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructCustomPlaceRequest originally named CustomPlaceRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructCustomPlaceRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructCustomPlaceRequestBody
     */
    public $Body;
    /**
     * Constructor method for CustomPlaceRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructCustomPlaceRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructCustomPlaceRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructCustomPlaceRequestBody $_body the Body
