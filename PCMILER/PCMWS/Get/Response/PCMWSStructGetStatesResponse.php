<?php
/**
 * File for class PCMWSStructGetStatesResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructGetStatesResponse originally named GetStatesResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructGetStatesResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructGetStatesResponseBody
     */
    public $Body;
    /**
     * Constructor method for GetStatesResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructGetStatesResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructGetStatesResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructGetStatesResponseBody $_body the Body
