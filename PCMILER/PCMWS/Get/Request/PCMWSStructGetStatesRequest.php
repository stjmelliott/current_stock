<?php
/**
 * File for class PCMWSStructGetStatesRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructGetStatesRequest originally named GetStatesRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructGetStatesRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructGetStatesRequestBody
     */
    public $Body;
    /**
     * Constructor method for GetStatesRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructGetStatesRequestBody $_body
     * @return PCMWSStructGetStatesRequest
     */
    ...
    /**
     * Get Body value
     * @return PCMWSStructGetStatesRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructGetStatesRequestBody $_body the Body
