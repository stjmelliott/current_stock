<?php
/**
 * File for class PCMWSStructGetAvoidFavorSetRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructGetAvoidFavorSetRequest originally named GetAvoidFavorSetRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructGetAvoidFavorSetRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructGetAvoidFavorSetRequestBody
     */
    public $Body;
    /**
     * Constructor method for GetAvoidFavorSetRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructGetAvoidFavorSetRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructGetAvoidFavorSetRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructGetAvoidFavorSetRequestBody $_body the Body
