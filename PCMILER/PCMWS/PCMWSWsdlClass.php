<?php
/**
 * File for PCMWSWsdlClass to communicate with SOAP service
 * @package PCMWS
 ...
 */
/**
 * PCMWSWsdlClass to communicate with SOAP service
 * 
 * @package PCMWS
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-08-25
 */
class PCMWSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://pcmiler.alk.com/APIs/SOAP/v1.0/Service.svc?Wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses PCMWSWsdlClass::setLastError()
     * @uses PCMWSWsdlClass::initSoapClient()
     * @uses PCMWSWsdlClass::initInternArrayToIterate()
     * @uses PCMWSWsdlClass::_set()
     ...
     * @return PCMWSWsdlClass|null
     */
    public static function __set_state(array $_array)
    {
        $_className = array_pop($_array);
        
        if(class_exists($_className))
        {
            $object = @new $_className();
            if(is_object($object) && is_subclass_of($object,'PCMWSWsdlClass'))
            {
     ...
     * @uses PCMWSClassMap::classMap()
     * @uses PCMWSWsdlClass::getDefaultWsdlOptions()
     * @uses PCMWSWsdlClass::getSoapClientClassName()
     * @uses PCMWSWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('PCMWSClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = PCMWSClassMap::classMap();
     ...
     * If a class is named as {PCMWS}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('PCMWSSoapClient') && is_subclass_of('PCMWSSoapClient','SoapClient'))
            return 'PCMWSSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses PCMWSWsdlClass::WSDL_CACHE_WSDL
     * @uses PCMWSWsdlClass::WSDL_COMPRESSION
     * @uses PCMWSWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses PCMWSWsdlClass::WSDL_ENCODING
     * @uses PCMWSWsdlClass::WSDL_EXCEPTIONS
     * @uses PCMWSWsdlClass::WSDL_FEATURES
     * @uses PCMWSWsdlClass::WSDL_LOGIN
     * @uses PCMWSWsdlClass::WSDL_PASSWORD
     * @uses PCMWSWsdlClass::WSDL_SOAP_VERSION
     * @uses PCMWSWsdlClass::WSDL_STREAM_CONTEXT
     * @uses PCMWSWsdlClass::WSDL_TRACE
     * @uses PCMWSWsdlClass::WSDL_TYPEMAP
     * @uses PCMWSWsdlClass::WSDL_URL
     * @uses PCMWSWsdlClass::VALUE_WSDL_URL
     * @uses PCMWSWsdlClass::WSDL_USER_AGENT
     * @uses PCMWSWsdlClass::WSDL_PROXY_HOST
     * @uses PCMWSWsdlClass::WSDL_PROXY_PORT
     * @uses PCMWSWsdlClass::WSDL_PROXY_LOGIN
     * @uses PCMWSWsdlClass::WSDL_PROXY_PASSWORD
     * @uses PCMWSWsdlClass::WSDL_LOCAL_CERT
     * @uses PCMWSWsdlClass::WSDL_PASSPHRASE
     * @uses PCMWSWsdlClass::WSDL_AUTHENTICATION
     * @uses PCMWSWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses PCMWSWsdlClass::getSoapClient()
     * @uses PCMWSWsdlClass::getFormatedXml()
     ...
     * @uses PCMWSWsdlClass::getSoapClient()
     * @uses PCMWSWsdlClass::convertStringHeadersToArray()
     ...
     * @uses PCMWSWsdlClass::getInternArrayToIterate()
     * @uses PCMWSWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses PCMWSWsdlClass::getInternArrayToIterateOffset()
     * @uses PCMWSWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses PCMWSWsdlClass::getInternArrayToIterateOffset()
     * @uses PCMWSWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses PCMWSWsdlClass::getAttributeName()
     * @uses PCMWSWsdlClass::__toString()
     * @uses PCMWSWsdlClass::_set()
     * @uses PCMWSWsdlClass::_get()
     * @uses PCMWSWsdlClass::setInternArrayToIterate()
     * @uses PCMWSWsdlClass::setInternArrayToIterateIsArray()
     * @uses PCMWSWsdlClass::setInternArrayToIterateOffset()
