<?php
/**
 * File for class PCMWSStructRouteMatrixResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructRouteMatrixResponse originally named RouteMatrixResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructRouteMatrixResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructRouteMatrixResponseBody
     */
    public $Body;
    /**
     * Constructor method for RouteMatrixResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructRouteMatrixResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructRouteMatrixResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructRouteMatrixResponseBody $_body the Body
