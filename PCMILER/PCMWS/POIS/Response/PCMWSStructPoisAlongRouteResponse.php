<?php
/**
 * File for class PCMWSStructPoisAlongRouteResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructPoisAlongRouteResponse originally named PoisAlongRouteResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructPoisAlongRouteResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructPoisAlongRouteResponseBody
     */
    public $Body;
    /**
     * Constructor method for PoisAlongRouteResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructPoisAlongRouteResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructPoisAlongRouteResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructPoisAlongRouteResponseBody $_body the Body
