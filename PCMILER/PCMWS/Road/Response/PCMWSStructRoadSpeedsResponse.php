<?php
/**
 * File for class PCMWSStructRoadSpeedsResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructRoadSpeedsResponse originally named RoadSpeedsResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructRoadSpeedsResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructRoadSpeedsResponseBody
     */
    public $Body;
    /**
     * Constructor method for RoadSpeedsResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructRoadSpeedsResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructRoadSpeedsResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructRoadSpeedsResponseBody $_body the Body
