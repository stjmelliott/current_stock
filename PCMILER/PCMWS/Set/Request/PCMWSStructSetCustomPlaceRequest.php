<?php
/**
 * File for class PCMWSStructSetCustomPlaceRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructSetCustomPlaceRequest originally named SetCustomPlaceRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructSetCustomPlaceRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructSetCustomPlaceRequestBody
     */
    public $Body;
    /**
     * Constructor method for SetCustomPlaceRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructSetCustomPlaceRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructSetCustomPlaceRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructSetCustomPlaceRequestBody $_body the Body
