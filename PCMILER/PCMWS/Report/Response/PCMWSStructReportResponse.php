<?php
/**
 * File for class PCMWSStructReportResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructReportResponse originally named ReportResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructReportResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructReportResponseBody
     */
    public $Body;
    /**
     * Constructor method for ReportResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructReportResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructReportResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructReportResponseBody $_body the Body
