<?php
/**
 * File for class PCMWSStructReportRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructReportRequest originally named ReportRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructReportRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructReportRequestBody
     */
    public $Body;
    /**
     ...
     * @param PCMWSStructReportRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructReportRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructReportRequestBody $_body the Body
