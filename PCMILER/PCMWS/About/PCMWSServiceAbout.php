<?php
/**
 * File for class PCMWSServiceAbout
 * @package PCMWS
 * @subpackage Services
 ...
 */
/**
 * This class stands for PCMWSServiceAbout originally named About
 * @package PCMWS
 * @subpackage Services
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-08-25
 */
class PCMWSServiceAbout extends PCMWSWsdlClass
{
    /**
    ...
    /**
     * Method to call the operation originally named AboutService
     ...
     * @param PCMWSStructAboutService $_pCMWSStructAboutService
     * @return PCMWSStructAboutServiceResponse
     */
    public function AboutService(PCMWSStructAboutService $_pCMWSStructAboutService)
    {
        try
        {
            return $this->setResult(self::getSoapClient()->AboutService($_pCMWSStructAboutService));
        }
