<?php
/**
 * File for class PCMWSStructWeatherAlertsPointsResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructWeatherAlertsPointsResponse originally named WeatherAlertsPointsResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructWeatherAlertsPointsResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructWeatherAlertsPointsReponseBody
     */
    public $Body;
    /**
     * Constructor method for WeatherAlertsPointsResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructWeatherAlertsPointsReponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructWeatherAlertsPointsReponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructWeatherAlertsPointsReponseBody $_body the Body
