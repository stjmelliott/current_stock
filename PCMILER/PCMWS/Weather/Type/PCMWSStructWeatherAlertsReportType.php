<?php
/**
 * File for class PCMWSStructWeatherAlertsReportType
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructWeatherAlertsReportType originally named WeatherAlertsReportType
 ...
 * @date 2016-08-25
 */
class PCMWSStructWeatherAlertsReportType extends PCMWSStructReportType
{
    /**
     * The Urgency
     * Meta informations extracted from the WSDL
     ...
     * @return PCMWSStructWeatherAlertsReportType
     */
    public function __construct($_urgency = NULL,$_severity = NULL,$_certainty = NULL,$_eventNames = NULL)
    {
        PCMWSWsdlClass::__construct(array('Urgency'=>$_urgency,'Severity'=>$_severity,'Certainty'=>$_certainty,'EventNames'=>($_eventNames instanceof PCMWSStructArrayOfstring)?$_eventNames:new PCMWSStructArrayOfstring($_eventNames)),false);
    }
    /**
     * Get Urgency value
