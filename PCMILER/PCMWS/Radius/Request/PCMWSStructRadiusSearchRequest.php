<?php
/**
 * File for class PCMWSStructRadiusSearchRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructRadiusSearchRequest originally named RadiusSearchRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructRadiusSearchRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructRadiusSearchRequestBody
     */
    public $Body;
    /**
     * Constructor method for RadiusSearchRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructRadiusSearchRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructRadiusSearchRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructRadiusSearchRequestBody $_body the Body
