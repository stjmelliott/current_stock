<?php
/**
 * File for class PCMWSStructRadiusSearchResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructRadiusSearchResponse originally named RadiusSearchResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructRadiusSearchResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructRadiusSearchResponseBody
     */
    public $Body;
    /**
     * Constructor method for RadiusSearchResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructRadiusSearchResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructRadiusSearchResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructRadiusSearchResponseBody $_body the Body
