<?php
/**
 * File for class PCMWSStructGeocodeRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructGeocodeRequest originally named GeocodeRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructGeocodeRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructGeocodeRequestBody
     */
    public $Body;
    /**
     * Constructor method for GeocodeRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructGeocodeRequestBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructGeocodeRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructGeocodeRequestBody $_body the Body
