<?php
/**
 * File for class PCMWSStructDriveTimePolygonResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructDriveTimePolygonResponse originally named DriveTimePolygonResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructDriveTimePolygonResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructDriveTimePolygonResponseBody
     */
    public $Body;
    /**
     * Constructor method for DriveTimePolygonResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructDriveTimePolygonResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructDriveTimePolygonResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructDriveTimePolygonResponseBody $_body the Body
