<?php
/**
 * File for class PCMWSStructReduceTripRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructReduceTripRequest originally named ReduceTripRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructReduceTripRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructReduceTripRequestBody
     */
    public $Body;
    /**
     * Constructor method for ReduceTripRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructReduceTripRequestBody $_body
     * @return PCMWSStructReduceTripRequest
     */
    ...
    /**
     * Get Body value
     * @return PCMWSStructReduceTripRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructReduceTripRequestBody $_body the Body
