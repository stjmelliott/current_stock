<?php
/**
 * File for class PCMWSStructArrayOfstring
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructArrayOfstring originally named ArrayOfstring
 ...
 * @date 2016-08-25
 */
class PCMWSStructArrayOfstring extends PCMWSWsdlClass
{
    /**
     * The string
     * Meta informations extracted from the WSDL
