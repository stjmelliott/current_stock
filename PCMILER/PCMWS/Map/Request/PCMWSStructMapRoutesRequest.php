<?php
/**
 * File for class PCMWSStructMapRoutesRequest
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructMapRoutesRequest originally named MapRoutesRequest
 ...
 * @date 2016-08-25
 */
class PCMWSStructMapRoutesRequest extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructMapRoutesRequestBody
     */
    public $Body;
    /**
     * Constructor method for MapRoutesRequest
     * @see parent::__construct()
     * @param PCMWSStructRequestHeader $_header
     * @param PCMWSStructMapRoutesRequestBody $_body
     * @return PCMWSStructMapRoutesRequest
     */
    ...
    /**
     * Get Body value
     * @return PCMWSStructMapRoutesRequestBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructMapRoutesRequestBody $_body the Body
