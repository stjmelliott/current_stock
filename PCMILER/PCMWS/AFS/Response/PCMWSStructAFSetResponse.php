<?php
/**
 * File for class PCMWSStructAFSetResponse
 * @package PCMWS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PCMWSStructAFSetResponse originally named AFSetResponse
 ...
 * @date 2016-08-25
 */
class PCMWSStructAFSetResponse extends PCMWSWsdlClass
{
    /**
     * The Header
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 0
     * - nillable : true
     * @var PCMWSStructAFSetResponseBody
     */
    public $Body;
    /**
     * Constructor method for AFSetResponse
     * @see parent::__construct()
     * @param PCMWSStructResponseHeader $_header
     * @param PCMWSStructAFSetResponseBody $_body
    ...
    /**
     * Get Body value
     * @return PCMWSStructAFSetResponseBody|null
     */
    ...
    /**
     * Set Body value
     * @param PCMWSStructAFSetResponseBody $_body the Body
